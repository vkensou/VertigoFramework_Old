public abstract class IProcedureManager
{
    ...
    public abstract void PushCommand(string procedure, UML.EnterEventArg firearg = null);
    public abstract void PushCommand(string procedure, UML.EnterEventArg firearg, bool shutdown);
