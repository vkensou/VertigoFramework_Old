...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.PrimaryEntityIndex<GameEntity, int>(
            EventHandler,
            game.GetGroup(GameMatcher.EventHandler),
            (e, c) => ((EventHandlerComponent)c).id));
    }
}

public static class ContextsExtensions {

    public static GameEntity GetEntityWithEventHandler(this GameContext context, int id) {
        return ((Entitas.PrimaryEntityIndex<GameEntity, int>)context.GetEntityIndex(Contexts.EventHandler)).GetEntity(id);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
